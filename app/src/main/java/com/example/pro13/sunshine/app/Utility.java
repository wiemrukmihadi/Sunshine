...
public class Utility {
    ...
    public static String getPeferredLocation(Context context){
    ...
    public static String formatHighAndLow(Context context, double high, double low){


        SharedPreferences sharedPref = PreferenceManager.getDefaultSharedPreferences(context);
        String unitType = sharedPref.getString(context.getString(R.string.pref_units_key),
                context.getString(R.string.pref_units_metric));
